...
const Preface = () => {
  return (
    <div className="flex flex-col w-1/3 border-r-4 border-[#4fa3a8] p-6 my-6 items-end overflow-auto">
      <img src={ToolKit} alt="toolkit-logo" className="w-[450px]" />
      <div className="flex items-center text-lg text-right mt-4 -z-10">
